        ...
        <div className='sidebar'>
            ...
            <div className='content'>
                <div className='chatbar'>
                    ...
                    <Room room={location.state.room + "1"} chatHeader="Global chat" scrollSize={scrollSize} />
                    ...
                    <div>
                        {characterName === 'werewolf' ?
                            <>
                            {/* {setScrollSize("30vh")} */}
                                < Room room={(location.state.Room + "2")} chatHeader="Wolf Chat" scrollSize={scrollSize} />
